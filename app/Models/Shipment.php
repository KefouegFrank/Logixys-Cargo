...
#[Fillable([
    ...
    'origin_label', 'origin_country', 'origin_lat', 'origin_lng', 'origin_location_id',
    'destination_label', 'destination_country', 'destination_lat', 'destination_lng', 'destination_location_id',
